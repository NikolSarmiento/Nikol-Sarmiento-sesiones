            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  Column(
                    children: const [Icon(Icons.favorite, color: Colors.white), Text('42')],
                  ),
                  Column(
                    children: const [Icon(Icons.comment, color: Colors.white), Text('42')],
                  ),
                  Column(
                    children: const [Icon(Icons.bookmark, color: Colors.white), Text('42')],
                  ),
                  Column(
                    children: const [Icon(Icons.share, color: Colors.white), Text('42')],
                  ),
                ],
              )
            ],
